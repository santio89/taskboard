...
const translations: Record<string, Record<Language, string>> = {
  ...
  'column.markDone': { en: 'Done column', es: 'Columna finalizada' },
  'column.markDoneHint': { en: 'Tasks moved here count as completed', es: 'Las tareas movidas aquí cuentan como completadas' },
